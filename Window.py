...
lbl = tk.Label(frame_alpr, text="Image Foregery Detection", font=('Times New Roman', 30,' bold '),bg="white",fg="black")
...
logo_label1=tk.Label(text='To develop a system that is capable \n of Identifying the type of Image Foregery...',compound='bottom',font=("Times New Roman", 20, 'bold', 'italic'),width=35, bg="white", fg="black")
